...
<?php $this->append('pagePlugins'); ?>
	...
	<?php //echo $this->Html->script('/plugins/estates-add/app');?>
...
<div class="col-md-12">
						<div class="portlet box blue" id="form_wizard_1">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-gift"></i> Form Wizard - <span class="step-title">Step 2 of 4</span>
								</div>
											...
											<div class="tab-content">
												...
												<div class="tab-pane" id="tab1">
													...
													<div class="form-group has-success">
														...
														* </span>
														...
														<div class="col-md-4">
															<input type="text" class="form-control" name="username" aria-required="true" aria-describedby="username-error" aria-invalid="false"><span id="username-error" class="help-block help-block-error valid"></span>
													...
													<div class="form-group has-success">
														...
														* </span>
														...
														<div class="col-md-4">
															<input type="password" class="form-control" name="password" id="submit_form_password" aria-required="true" aria-describedby="submit_form_password-error" aria-invalid="false"><span id="submit_form_password-error" class="help-block help-block-error valid"></span>
															<span class="help-block">
													...
													<div class="form-group has-success">
														...
														* </span>
														...
														<div class="col-md-4">
															<input type="password" class="form-control" name="rpassword" aria-required="true" aria-describedby="rpassword-error" aria-invalid="false"><span id="rpassword-error" class="help-block help-block-error valid"></span>
															<span class="help-block">
													...
													<div class="form-group has-success">
														...
														* </span>
														...
														<div class="col-md-4">
															<input type="text" class="form-control" name="email" aria-required="true" aria-describedby="email-error" aria-invalid="false"><span id="email-error" class="help-block help-block-error valid"></span>
															<span class="help-block">
												...
												<div class="tab-pane active" id="tab2">
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<div class="select2-container form-control" id="s2id_country_list"><a href="javascript:void(0)" class="select2-choice select2-default" tabindex="-1">   <span class="select2-chosen" id="select2-chosen-1">Select</span><abbr class="select2-search-choice-close"></abbr>   <span class="select2-arrow" role="presentation"><b role="presentation"></b></span></a><label for="s2id_autogen1" class="select2-offscreen"></label><input class="select2-focusser select2-offscreen" type="text" aria-haspopup="true" role="button" aria-labelledby="select2-chosen-1" id="s2id_autogen1"><div class="select2-drop select2-display-none select2-with-searchbox">   <div class="select2-search">       <label for="s2id_autogen1_search" class="select2-offscreen"></label>       <input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" class="select2-input" role="combobox" aria-expanded="true" aria-autocomplete="list" aria-owns="select2-results-1" id="s2id_autogen1_search" placeholder="">   </div>   <ul class="select2-results" role="listbox" id="select2-results-1">   </ul></div></div><select name="country" id="country_list" class="form-control select2-offscreen" tabindex="-1" title="">
																<option value=""></option>
